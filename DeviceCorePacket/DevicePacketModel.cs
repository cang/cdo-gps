...
{
    [DataContract]
    public abstract class DevicePacketModel : IDisposable, IDeviceSendPacket, IDeviceRecvPacket
    {
        protected readonly MemoryStream _memory;
        private readonly BinaryReader _reader;
        private readonly BinaryWriter _write;

        protected DevicePacketModel()
        {
        ...
        protected DevicePacketModel(byte[] data)
        {
            OriginalData = data;

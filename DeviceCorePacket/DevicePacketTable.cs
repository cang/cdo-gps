...
{
    [Export(typeof (IDevicePacketTable))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class DevicePacketTable : IPartImportsSatisfiedNotification, IDevicePacketTable
    {
        [ImportMany] private IEnumerable<Lazy<DevicePacketModel, IOpcodeAttribute>> _importPacket;

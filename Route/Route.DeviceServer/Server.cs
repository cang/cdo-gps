...
namespace Route.DeviceServer
{
    ...
    [Export(typeof (Server))]
    [PartCreationPolicy(CreationPolicy.Shared)]
    public class Server : IModuleFactory, IPartImportsSatisfiedNotification
    {
        ...
        public int MaxConnect { get; } = 50000;
        ...
        public void OnImportsSatisfied()
        {
            ...
            _cfg = _configManager.Read<ServerConfig>($@"{_path}\{ConfigFolder}\DeviceServer.xml");
        ...
        {
            new ClientConnect(e.Client, _log, _packetTable, _handleTable, _cachePacket, _deviceRoute);
        }
    }
}
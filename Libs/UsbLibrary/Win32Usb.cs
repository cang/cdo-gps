...
using static UsbLibrary.HIDDevice;
...
namespace UsbLibrary
{
    ...
    public class Win32Usb
    {
        ...
        [DllImport("setupapi.dll", SetLastError = true , CharSet = CharSet.Auto)] protected static extern IntPtr SetupDiGetClassDevs(ref Guid gClass, IntPtr strEnumerator, IntPtr hParent, uint nFlags);
		/// <summary>
        ...
        [DllImport("setupapi.dll", SetLastError = true)] protected static extern bool SetupDiEnumDeviceInterfaces(IntPtr lpDeviceInfoSet, IntPtr nDeviceInfoData, ref Guid gClass, int nIndex, ref DeviceInterfaceData oInterfaceData);
        /// <summary>
        ...
        //[DllImport("setupapi.dll", SetLastError = true, CharSet = CharSet.Ansi)]
        //protected static extern bool SetupDiGetDeviceInterfaceDetail(IntPtr lpDeviceInfoSet, ref DeviceInterfaceData oInterfaceData,
        // IntPtr lpDeviceInterfaceDetailData, uint nDeviceInterfaceDetailDataSize, ref uint nRequiredSize, IntPtr lpDeviceInfoData);
        /// <summary>
        /// SetupDiGetDeviceInterfaceDetail
        /// Gets the interface detail from a DeviceInterfaceData. This is pretty much the device path.
        /// You call this twice, once to get the size of the struct you need to send (nDeviceInterfaceDetailDataSize=0)
        ...
        /// <param name="lpDeviceInfoData">Not used</param>
        /// <returns></returns>
        //[DllImport("setupapi.dll", SetLastError = true)] protected static extern bool SetupDiGetDeviceInterfaceDetail(IntPtr lpDeviceInfoSet, ref DeviceInterfaceData oInterfaceData, IntPtr oDetailData, uint nDeviceInterfaceDetailDataSize, ref uint nRequiredSize, IntPtr lpDeviceInfoData);
        /// <summary>
        ...
        [DllImport("user32.dll",   SetLastError = true)] protected static extern IntPtr RegisterDeviceNotification(IntPtr hwnd, IntPtr oInterface, uint nFlags);
		/// <summary>
        ...
        public static IntPtr RegisterForUsbEvents(IntPtr hWnd, Guid gClass)
        {
            ...
            var size = Marshal.SizeOf(oInterfaceIn);
            var devBroadcastDeviceInterfaceBuffer  = Marshal.AllocHGlobal(size);
            Marshal.StructureToPtr
            (oInterfaceIn,
            devBroadcastDeviceInterfaceBuffer,
            true);
            return RegisterDeviceNotification(hWnd, devBroadcastDeviceInterfaceBuffer, DEVICE_NOTIFY_WINDOW_HANDLE);
        }
		/// <summary>

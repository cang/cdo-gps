...
namespace Hik.Communication.Scs.Communication.Channels.Tcp
{
    ...
    internal class TcpCommunicationChannel : CommunicationChannelBase
    {
        ...
        void _tCheckValidConnect_Elapsed(object sender, EventArgs e)
        {
            ...
            if (_clientSocket != null)
            {
                ...
                try
                {
                    ...
                    _clientSocket.Send(tmp, 1, SocketFlags.None);
                ...
                //Console.WriteLine("Connected: {0}", _workSocket.Connected);
            }
        }
